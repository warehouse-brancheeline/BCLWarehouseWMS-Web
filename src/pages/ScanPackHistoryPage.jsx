...
function ScanPackHistoryPage({
  ...
  const loadTaskItems = useCallback(
    async (task) => {
      ...
      try {
        ...
        console.error(
          'Gagal memuat detail History Packing:',
          loadError,
        )
    ...
    try {
      ...
      setSelectedTask((currentTask) => {
        ...
        return {
          ...
          cancelled_packages:
            Number(
              currentTask.cancelled_packages ||
                0,
            ) + 1,
        }
      })
  ...
  const downloadTaskList = () => {
    const rows = tasks.map((task) => ({
      ...
      'Total Paket':
        task.total_packages || 0,
      'Paket Aktif':
        task.active_packages || 0,
      'Order Cancel':
          ...
          <section className="sph-panel">
            <div className="sph-panel-header">
              <div>
                ...
                <p>
                  Cari resi kemudian tandai
                  cancel jika order dibatalkan.
                </p>
              </div>
    ...
    <main className="sph-page">
      <header className="sph-header">
        <div>
          ...
          <p className="sph-subtitle">
            Riwayat packing berdasarkan Nomor
            Tugas.
          </p>
        </div>
      ...
      <section className="sph-content">
        <form
          className="sph-search-panel"
          onSubmit={handleSearch}
        >
          <label>
            <span>
              Cari nomor tugas atau nomor resi
            </span>
          ...
          <section className="sph-panel">
            <div className="sph-panel-header">
              <div>
                ...
                <p>
                  Klik Nomor Tugas untuk melihat
                  seluruh resi.
                </p>
              </div>
            </div>
                ...
                <tbody>
                  {tasks.map((task) => (
                    <tr key={task.session_id}>
                      ...
                      <td>
                        {task.active_packages ||
                          0}
                      </td>

                      <td>
                        <span className="sph-cancel-count">
                          {task.cancelled_packages ||
                            0}
                        </span>
                      </td>
