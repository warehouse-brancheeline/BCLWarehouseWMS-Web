...
function CancelledShipmentsPage({
  ...
  const filteredRows = useMemo(() => {
    const keyword =
      normalizeTrackingNumber(search)
  ...
  const handleSubmit = async (event) => {
    ...
    if (trackingNumbers.length === 0) {
      setError(
        'Masukkan minimal satu nomor resi.',
      )
      return
    }
    ...
    const payload = trackingNumbers.map(
      (trackingNumber) => ({
        ...
        <section className="cancel-layout">
          ...
          >
            <div className="section-heading">
              ...
              <span className="website-only-label">
                Website Only
              </span>
            </div>

            <label htmlFor="trackingInput">
              Nomor Resi
            </label>
            ...
            <div className="cancel-warning">
              Resi yang aktif di daftar cancel
              akan ditolak saat Check Pack
              dan diperiksa kembali saat
              Handover.
            </div>
          ...
          <section className="cancel-information-card">
            ...
            <div className="validation-step">
              ...
              <div>
                ...
                <p>
                  Resi cancel langsung
                  ditolak sebelum proses
                  packing dilanjutkan.
                </p>
              </div>
            </div>
            ...
            <div className="validation-step">
              ...
              <div>
                ...
                <p>
                  Resi diperiksa kembali.
                  Paket yang terlanjur
                  dipacking tetap ditolak
            ...
            <div className="validation-step">
              ...
              <div>
                ...
                <p>
                  Admin dapat mencabut
                  status cancel apabila
                  order dinyatakan boleh
                  diproses kembali.
                </p>
              </div>
            </div>
